 ...
 * <p>
 * Before you start with the implementation of this interface, it is important to consider how your cryptographic
 * library implements the {@link Keyset}, {@link Algorithm} and {@link KeysetFactory} interfaces.
 * <p>
 * What is it that can be used to uniquely identify both a {@link KeysetDefinition} and {@link EncryptedKeyset}
 * uniquely to your cryptographic library?
 * <p>
...
public interface KeysetFactory {
	 ...
	 * it would attempt to decrypt the private key material with the specified <code>KEK</code>.
	 *
	 ...
	 * @throws IOException when there is an issue while generating the private key material.
	 */
	Keyset create(KeyEncryptionKey kek, KeysetDefinition definition) throws IOException;

	/**
	 * Creates a new {@link EncryptedKeyset} that should be stored by the {@link KeysetRepository}.
	 *
	 ...
	 */
	EncryptedKeyset create(Keyset keyset) throws IOException;

	/**
	 * Creates a new {@link Keyset} from the loaded {@link EncryptedKeyset} that would be
	 * decrypted by the {@link KeyEncryptionKey}.
	 *
	 * @param kek Key encryption key used to unwrap the encrypted private key material, can't be {@literal null}.
	 ...
	 */
	Keyset create(KeyEncryptionKey kek, EncryptedKeyset encryptedKeyset) throws IOException;
